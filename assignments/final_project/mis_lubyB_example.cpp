...
int main(int argc, char **argv) {
  ...
  if (world.rank0()) {
    // Just add edges
    add_edge_to_graph(graph, 0, 1);
    add_edge_to_graph(graph, 0, 3);
    add_edge_to_graph(graph, 1, 3);
    add_edge_to_graph(graph, 1, 2);
    add_edge_to_graph(graph, 2, 4);
    add_edge_to_graph(graph, 3, 4);
    add_edge_to_graph(graph, 4, 5);
    add_edge_to_graph(graph, 3, 5);
  }
